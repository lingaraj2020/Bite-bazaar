...
const Cart = () => {
    ...
    if (cartItems.length === 0) {
        ...
        <div className="m-auto lg:w-6/12 md:w-6/12 w-11/12 h-fit flex flex-col justify-center items-center lg:py-10 md:py-10 py-8">
            <div><img className="lg:w-80 md:w-80 w-40"  alt=""src={cartImg}></img></div>
            ...
            <div className="pt-4">
                <Link to="/restaurant">
            <span className="bg-orange-400 py-2 px-3 text-base font-bold text-white hover:bg-transparent hover:rounded-md   hover:border-2 hover:border-black hover:text-black">SEE RESTAURANTS NEAR YOU</span>
            </Link>
            </div>
        </div>
        )
